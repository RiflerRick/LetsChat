...
s.connect((host, port))
print ('message received from server: {}'.format(str(s.recv(1024))))          # here 1024 is the buffer size, which means we are trying to basically receive a message of size 1024 
while True:
