...
while True:
    """
    There is one very important idea here and that is once a new client joins there is no way of updating the old threads for new clients, so we need to respawn all the threads. This implementation is discouraged.
    """
